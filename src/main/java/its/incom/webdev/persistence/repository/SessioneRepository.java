...
public class SessioneRepository {
    ...
    public int insertSessione(int id_utente) throws SQLException {
        try (Connection connection = database.getConnection()) {
            String query = "INSERT INTO Sessione (id_utente) VALUES (?)";
            ...
            throw new SQLException("Cannot insert new session for partecipante" + id_utente);
        }
            ...
            try (PreparedStatement statement = connection.prepareStatement(query)) {
                ...
                try (ResultSet resultSet = statement.executeQuery()) {
                    if (resultSet.next()) {
                        ...
                        Timestamp dataCreazione = resultSet.getTimestamp("data");
                        int utenteId = resultSet.getInt("id_utente");
